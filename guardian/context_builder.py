...
symbols: list[ChangedSymbolContext] = field(
    default_factory=list
)
```
...
def to_dict(self) -> dict[str, Any]:
    return {
        ...
        "repository": {
            ...
            "api_spec_files": (
                self.repository.api_spec_files
            ),
            "migration_files": (
                self.repository.migration_files
            ),
        },
